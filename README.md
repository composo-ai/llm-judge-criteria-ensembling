...
@misc{lail2026llmjudge,
  ...
  archivePrefix={arXiv},
  primaryClass={cs.CL},
  note={Accepted at the ICML 2026 workshops "Statistical Frameworks for Uncertainty in Agentic Systems" and "Combining Theory and Benchmarks: Towards a Virtuous Cycle to Understand and Guarantee Foundation Model Performance"},
}
```
